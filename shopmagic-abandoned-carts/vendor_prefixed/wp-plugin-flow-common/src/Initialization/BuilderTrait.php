...
namespace ShopMagicCartVendor\WPDesk\Plugin\Flow\Initialization;

use ShopMagicCartVendor\WPDesk\PluginBuilder\Plugin\Activateable;
use ShopMagicCartVendor\WPDesk\PluginBuilder\Plugin\Deactivateable;
...
trait BuilderTrait
{
     ...
     * @return SlimPlugin
     */
    private function build_plugin(\ShopMagicCartVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    private function init_register_hooks(\ShopMagicCartVendor\WPDesk_Plugin_Info $plugin_info, SlimPlugin $plugin)
    {
