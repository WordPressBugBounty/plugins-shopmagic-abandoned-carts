...
namespace ShopMagicCartVendor\WPDesk\Plugin\Flow;
...
{
    const LIBRARY_TEXT_DOMAIN = 'shopmagic-abandoned-carts';
     ...
     */
    private function init_translations(\ShopMagicCartVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \ShopMagicCartVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \ShopMagicCartVendor\WPDesk_Plugin_Info();
