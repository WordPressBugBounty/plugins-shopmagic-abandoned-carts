...
namespace ShopMagicCartVendor\WPDesk\Notice;

use ShopMagicCartVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use ShopMagicCartVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
