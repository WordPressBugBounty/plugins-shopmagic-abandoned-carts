...
if (!\function_exists('ShopMagicCartVendor\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    {
        $ajax_handler = new \ShopMagicCartVendor\WPDesk\Notice\AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('ShopMagicCartVendor\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('ShopMagicCartVendor\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    {
        return \ShopMagicCartVendor\WPDesk\Notice\Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('ShopMagicCartVendor\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('ShopMagicCartVendor\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    {
        return \ShopMagicCartVendor\WPDesk\Notice\Factory::notice($noticeContent, \ShopMagicCartVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
if (!\function_exists('ShopMagicCartVendor\wpdesk_wp_notice_info')) {
    /**
     * Creates Notice Info.
     *
...
if (!\function_exists('ShopMagicCartVendor\WPDeskWpNoticeError')) {
    /**
    ...
    {
        return \ShopMagicCartVendor\WPDesk\Notice\Factory::notice($noticeContent, \ShopMagicCartVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('ShopMagicCartVendor\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('ShopMagicCartVendor\WPDeskWpNoticeWarning')) {
    /**
    ...
    {
        return \ShopMagicCartVendor\WPDesk\Notice\Factory::notice($noticeContent, \ShopMagicCartVendor\WPDesk\Notice\Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('ShopMagicCartVendor\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('ShopMagicCartVendor\WPDeskWpNoticeSuccess')) {
    /**
    ...
    {
        return \ShopMagicCartVendor\WPDesk\Notice\Factory::notice($noticeContent, \ShopMagicCartVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
if (!\function_exists('ShopMagicCartVendor\wpdesk_wp_notice_success')) {
    /**
     * Creates Notice Success.
     *
...
if (!\function_exists('ShopMagicCartVendor\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    {
        return \ShopMagicCartVendor\WPDesk\Notice\Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('ShopMagicCartVendor\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *
